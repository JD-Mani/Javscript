  ...
  navigator.getBattery().then((batt) => {
    updateBattery = () => {
      ...
      if (level == 100) {
        ...
        batteryStatus.innerHTML = `Low Charge <i class="ri-battery-low-line animated-red"></i>`;
      } else if (batt.charging) {
        batteryStatus.innerHTML = `Charging ... <i class="ri-battery-2-charge-fill animated-green"></i>`;
      } else {
